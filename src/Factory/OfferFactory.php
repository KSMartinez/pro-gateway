...
final class OfferFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'datePosted' => self::faker()->dateTimeBetween("-1 years", "now"),
            ...
            'direct' => self::faker()->boolean(),
            'public' => self::faker()->boolean(),
            'accessibleForDisabled' => self::faker()->boolean(),
            ...
            'levelOfEducations' => [factory(LevelOfEducation::class)->random()]
        ];
    }
