...
#[AsCommand(name: 'app:offers:alert', description: 'Command that goes through the saved search of users to alert them with notifications if new offers matching the search criteria were found',)]
class OffersAlertCommand extends Command
{
